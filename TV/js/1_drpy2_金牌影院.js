...
let sign = CryptoJS.SHA1(CryptoJS.MD5(`id=${kids[5]}&nid=${kids[7]}&key=cb808529bae6b6be45ecfab29a4889bc&t=${t}`).toString()).toString();
let kurl = `${HOST}/api/mw-movie/anonymous/v1/video/episode/url?id=${kids[5]}&nid=${kids[7]}`;
...
kurl = JSON.parse(khtml).data.playUrl;
